  ...
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background-color: #FFFEF9; padding: 40px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
      ...
      <div style="text-align: center; margin: 40px 0;">
        <a href="${sampleData.songUrl}" style="display: inline-block; background: linear-gradient(135deg, #8B4513 0%, #A0522D 100%); color: #F5F5DC; text-decoration: none; padding: 18px 40px; font-size: 18px; border-radius: 30px; font-weight: bold; box-shadow: 0 4px 15px rgba(139, 69, 19, 0.3);">
          🎵 Listen to Your Song
        </a>
      </div>
